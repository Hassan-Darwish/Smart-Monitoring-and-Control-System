 ...
 * [Description]   The port where the buzzer is connected (Port D in this case).
 *----------------------------------------------------------------------------*/
#define BUZZER_PORT_ID								GPIO_PORTD

/*------------------------------------------------------------------------------
 * [Constant Name] BUZZER_PIN_ID
 * [Description]   The pin number where the buzzer is connected (Pin 3 in this case).
 *----------------------------------------------------------------------------*/
#define BUZZER_PIN_ID								GPIO_PIN3
