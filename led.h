...
#define LED_PORT_ID                        GPIO_PORTB  // Define the port for the LEDs

#define LED_RED_PIN                        GPIO_PIN5   // Define the pin for the red LED
#define LED_GREEN_PIN                      GPIO_PIN6   // Define the pin for the green LED
#define LED_BLUE_PIN                       GPIO_PIN7   // Define the pin for the blue LED
